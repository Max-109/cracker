...
const iconButtonVariants = cva(
  "inline-flex items-center justify-center border transition-all duration-150 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 outline-none group",
  {
    variants: {
      variant: {
        ...
        danger: "border-[var(--border-color)] bg-[#141414] text-[var(--text-secondary)] hover:border-red-500 hover:text-red-500",
