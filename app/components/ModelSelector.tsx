        ...
        <div className="relative">
          ...
          {isModelMenuOpen && (
            <>
              ...
              <div className="absolute top-full right-0 md:left-0 md:right-auto mt-1 w-[240px] bg-[var(--bg-sidebar)] border border-[var(--border-color)] overflow-hidden z-[9999] p-2 animate-in fade-in zoom-in-95 duration-100 origin-top-right md:origin-top-left">
